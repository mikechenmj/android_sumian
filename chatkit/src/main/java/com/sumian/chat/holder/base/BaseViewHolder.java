package com.sumian.chat.holder.base;
...
public abstract class BaseViewHolder<T> extends RecyclerView.ViewHolder {
    ...
    public abstract void initView(boolean isLeft, int serviceType, T msg);
    ...
    protected void showText(TextView tvContent, AVIMMessage msg) {
        String content;
        if (msg instanceof AVIMTextMessage) {
            content = ((AVIMTextMessage) msg).getText().trim();
        } else {
    ...
    protected void formatServiceType(CircleImageView civIcon, int serviceType) {
        ...
        BaseApp
            .getRequestManager()
            .load(mIsLeft ? mipmapId : AppManager.getAccountModel().getUser().getAvatar())
            .asBitmap()
