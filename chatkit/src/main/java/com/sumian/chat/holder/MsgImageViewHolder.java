...
public class MsgImageViewHolder extends BaseViewHolder<AVIMImageMessage> implements View.OnClickListener {
    ...
    public MsgImageViewHolder(ViewGroup parent, boolean isLeft) {
        super(parent, isLeft ? R.layout.lay_item_left_image_chat : R.layout.lay_item_right_image_chat);
        super.mIsLeft = isLeft;
    }

    @Override
    public void initView(boolean isLeft, int serviceType, AVIMImageMessage msg) {
        super.mIsLeft = isLeft;
        this.mCacheMsg = msg;
