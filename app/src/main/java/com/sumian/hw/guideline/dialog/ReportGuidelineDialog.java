package com.sumian.hw.guideline.dialog;
...
import com.sumian.hw.guideline.utils.GuidelineUtils;import com.sumian.sd.R;
import com.sumian.hw.guideline.utils.GuidelineUtils;

import static com.sumian.hw.guideline.utils.GuidelineUtils.SP_KEY_NEED_SHOW_DAILY_REPORT_USER_GUIDE;
    ...
    public void onClick(View v) {
        ...
        switch (mStep) {
            ...
            case 2:
                ...
                break;
            default:
                GuidelineUtils.putBoolean(GuidelineUtils.SP_KEY_NEED_SHOW_DAILY_REPORT_USER_GUIDE, false);
                cancel();
                break;
        }
    }
