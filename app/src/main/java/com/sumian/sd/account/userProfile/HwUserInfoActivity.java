...
import com.sumian.sd.account.login.AvatarImageActivity;
import com.sumian.sd.account.login.ModifyNicknameActivity;
...
public class HwUserInfoActivity extends HwBaseActivity implements TitleBar.OnBackClickListener
        , SwipeRefreshLayout.OnRefreshListener, View.OnClickListener, HwUserInfoContract.View {
    ...
    private HwUserInfoContract.Presenter mPresenter;
    private UserInfo mUserInfo;

    public static void show(Context context) {
        context.startActivity(new Intent(context, HwUserInfoActivity.class));
    }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.lay_avatar) {
            ...
            commitBottomSheet(SelectGenderBottomSheet.newInstance(com.sumian.sd.account.login.ModifyUserInfoContract.KEY_GENDER));
        } else if (id == R.id.lay_area) {
            formKey = com.sumian.sd.account.login.ModifyUserInfoContract.KEY_AREA;
        } else if (id == R.id.lay_birthday) {
            formKey = com.sumian.sd.account.login.ModifyUserInfoContract.KEY_BIRTHDAY;
        } else if (id == R.id.lay_height) {
            formKey = com.sumian.sd.account.login.ModifyUserInfoContract.KEY_HEIGHT;
