package com.sumian.sd.report.calendar;
        ...
        mBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                switch (intent.getAction()) {
                    case CalendarAdapter.ViewHolder.CALENDER_GO_BACK_TODAY_ACTION:
                        ...
                        break;
                    case CalendarAdapter.ViewHolder.CALENDAR_GO_NEXT_ACTION:
                    case CalendarAdapter.ViewHolder.CALENDAR_GO_PRE_ACTION:
                        int position = intent.getIntExtra(CalendarAdapter.ViewHolder.EXTRA_POSITION, 0);
