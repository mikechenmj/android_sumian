 ...
 *
 */
class TouchDailySleepHistogramViewDeepAttr : SkinAttr() {

    override fun applySkin(view: View?) {
        val touchDailySleepHistogramView = view as? TouchDailySleepHistogramView
        if (isColor) {
            touchDailySleepHistogramView?.setDeepColor(SkinResourcesUtils.getColor(attrValueRefId))
        }
    }
    ...
    override fun applyNightMode(view: View?) {
        ...
        val touchDailySleepHistogramView = view as? TouchDailySleepHistogramView
        if (isColor) {
            touchDailySleepHistogramView?.setDeepColor(SkinResourcesUtils.getNightColor(attrValueRefId))
        }
    }
}