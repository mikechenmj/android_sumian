 ...
 *
 */
class TouchDailySleepHistogramViewTextAttr : SkinAttr() {

    override fun applySkin(view: View?) {
        val touchDailySleepHistogramView = view as? TouchDailySleepHistogramView
        if (isColor) {
            touchDailySleepHistogramView?.setTextColor(SkinResourcesUtils.getColor(attrValueRefId))
        }
    }
    ...
    override fun applyNightMode(view: View?) {
        ...
        val touchDailySleepHistogramView = view as? TouchDailySleepHistogramView
        if (isColor) {
            touchDailySleepHistogramView?.setTextColor(SkinResourcesUtils.getNightColor(attrValueRefId))
        }
    }
}