package com.sumian.sd.theme.three.loader;
...
import com.sumian.sd.theme.three.SkinLoaderListener;
import com.sumian.sd.theme.three.utils.ResourcesCompat;
import com.sumian.sd.theme.three.utils.SkinFileUtils;
import com.sumian.sd.theme.three.utils.SkinL;
import com.sumian.sd.theme.three.utils.TypefaceUtils;
...
public class SkinManager implements ISkinLoader {
    ...
    public ColorStateList getNightColorStateList(int resId) {
        ...
        if (resName.contains("_day")) {
            resName = resName.substring(0, resName.indexOf("_day"));
        }
