...
import com.sumian.app.tab.report.contract.MonthSleepContract;
...
public class MonthSleepPresenter implements MonthSleepContract.Presenter {
    ...
    private void requestDispatcher(String today, int year, int month) {
        ...
        Call<SleepDurationReport> daySleepReportCall = HwAppManager.getNetEngine().getHttpService().syncMonthSleepReport(today);
