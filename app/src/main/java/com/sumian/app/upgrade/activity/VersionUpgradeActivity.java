...
import com.sumian.app.upgrade.dialog.VersionDialog;
import com.sumian.app.upgrade.presenter.VersionUpgradePresenter;
    ...
    protected void initData() {
        ...
        switch (mVersionType) {
            case VERSION_TYPE_APP:
                ...
                currentVersion = UiUtil.getPackageInfo(App.getAppContext()).versionName;
                break;
