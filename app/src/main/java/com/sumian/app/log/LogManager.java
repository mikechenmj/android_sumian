...
public class LogManager {
    ...
    private LogManager() {
        ...
        this.mLogFile = new File(App.getAppContext().getCacheDir(), LOG_FILE_NAME);
    }
    ...
    private static String getAppInfo() {
        ...
        try {
            PackageInfo packageInfo = packageManager.getPackageInfo(App.getAppContext().getPackageName(), 0);
