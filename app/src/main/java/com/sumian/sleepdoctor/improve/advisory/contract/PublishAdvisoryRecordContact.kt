...
interface PublishAdvisoryRecordContact {
    ...
    interface Presenter : BasePresenter<Any> {
        ...
        fun publishAdvisoryRecord(advisoryId: Int, content: String, onlineReportIds: IntArray?)

        fun publishPictureAdvisoryRecord(advisoryId: Int, content: String, onlineReportIds: IntArray?, pictureCount: Int)
