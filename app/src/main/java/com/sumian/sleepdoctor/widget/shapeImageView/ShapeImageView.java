package com.sumian.sleepdoctor.widget.shapeImageView;
...
import com.sumian.sleepdoctor.widget.shapeImageView.util.DisplayUtil;
...
public class ShapeImageView extends AppCompatImageView {
    ...
    public ShapeImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = array.getDimensionPixelSize(R.styleable.ShapeImageView_riv_border_width, 0);
        mBorderColor = array.getColor(R.styleable.ShapeImageView_riv_border_color, DEFAULT_BORDER_COLOR);
        mPressedBorderWidth = array.getDimensionPixelSize(R.styleable.ShapeImageView_riv_pressed_border_width, mBorderWidth);
        mPressedBorderColor = array.getColor(R.styleable.ShapeImageView_riv_pressed_border_color, mBorderColor);
        mPressedMaskColor = array.getColor(R.styleable.ShapeImageView_riv_pressed_mask_color, Color.TRANSPARENT);
        ...
        mPressedModeEnabled = array.getBoolean(R.styleable.ShapeImageView_riv_pressed_mode_enabled, true);
        mIsCircle = array.getBoolean(R.styleable.ShapeImageView_riv_is_circle, false);
        mCornerRadius = array.getDimensionPixelSize(R.styleable.ShapeImageView_riv_corner_radius, 0);
        array.recycle();
    }
