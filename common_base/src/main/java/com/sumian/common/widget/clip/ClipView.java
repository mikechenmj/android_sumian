package com.sumian.common.widget.clip;
...
public class ClipView extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    private static boolean IS_UP_KITKAT = true;//Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT;
    private Path mPath;
    ...
    private void doUpdate(float progress) {
        mColor = changeColorAlpha(Color.WHITE, (int) (240 - (240 * progress)));
