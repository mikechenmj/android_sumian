...
public class LCIMPlayButton extends TextView implements View.OnClickListener {
    ...
    private void stopRecordAnimation() {
        setCompoundDrawablesWithIntrinsicBounds(leftSide ? R.drawable.lcim_group_chatbubble_icon_left_4 : 0,
                0, !leftSide ? R.drawable.lcim_group_chatbubble_icon_right_4 : 0, 0);
        if (anim != null) {
            anim.stop();
        }
    }
