...
public class NiceVideoView extends FrameLayout implements INiceVideoPlayer, TextureView.SurfaceTextureListener {
     ...
     * AliyunPlayer
     **/
    public static final int TYPE_ALIYUN = 333;
    private static final String TAG = NiceVideoView.class.getSimpleName();
    private int mPlayerType = TYPE_ALIYUN;
    ...
    private IMediaPlayer.OnPreparedListener mOnPreparedListener = new IMediaPlayer.OnPreparedListener() {
        ...
        public void onPrepared(IMediaPlayer mp) {
            ...
            if (continueFromLastPosition) {
                long savedPlayPosition = NiceUtil.getSavedPlayPosition(mContext, formatVideoUrl2SavePlayPosition());
                if (savedPlayPosition >= 10 * 1000) {
                    savedPlayPosition -= 10000;
                } else {
                    savedPlayPosition = 0;
                }
    ...
    public void setOnVideoViewEvent(OnVideoViewEvent onVideoViewEvent) {
        mOnVideoViewEvent = onVideoViewEvent;
    }
    ...
    private void initMediaPlayer() {
        if (mMediaPlayer == null) {
            switch (mPlayerType) {
                ...
                case TYPE_ALIYUN:
                default:
                    mMediaPlayer = new AliyunPlayer(getContext());
                    break;
