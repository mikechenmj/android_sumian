...
object StatConstants {
    ...
    const val click_captcha = "click_captcha"
    const val click_wechat_login = "click_wechat_login"
    ...
    const val page_personal_info = "个人信息页"
    const val page_cbti_chapter_list = "CBTI主页"
    const val page_cbti_introduction_from_banner = "CBTI介绍页"
    const val page_cbti_introduction_from_learn_more = "二级CBTI介绍页"
    const val page_pay = "支付页"
    const val page_cbti_chapter_content_list = "CBTI课程列表页"
    const val page_cbti_write_comment = "填写留言页"
    const val page_cbti_detail = "CBTI视频详情页"
    const val page_cbti_exercise = "练习页"    // h5
    const val page_relaxation_list = "放松训练列表页"
    const val page_relaxation_detail = "放松训练详情页"
    const val page_scale_list = "量表列表页"
    const val page_scale_detail = "量表详情页"
    const val page_sleep_health_list = "睡眠卫生列表页"
    const val page_sleep_health_detail = "睡眠卫生详情页"  // h5
    ...
    const val page_sleep_steward = "睡眠管家页"
    const val page_sleep_diary_detail = "睡眠日记详情页"
    const val page_weekly_sleep_diary = "日记周报告页"
    const val page_sleep_diary_edit = "日记题目页"
    ...
    const val page_doctor_service_introduction = "医生服务介绍页"
    const val page_image_text_consult_edit = "图文咨询提问页"
    const val page_consult_send_success = "医生服务提交成功页"
    const val page_image_text_consult_detail = "图文咨询详情页"
    const val page_online_report_list = "电子报告列表页"
    const val page_tel_consult_book_edit = "电话咨询预约页"
    const val page_tel_consult_book_detail = "电话咨询预约详情页"
    const val page_diary_evaluation_edit = "日记评估提问页"
    const val page_diary_evaluation_detail = "日记评估详情页"
    const val page_me_tab = "我的页"
    const val page_notification_list = "消息中心页"
    const val page_image_text_consult_list = "咨询记录页"
    const val page_tel_consult_book_record_list = "电话预约记录页面"
    const val page_diary_evaluation_list = "日记评估记录页"
    const val page_sleep_archive = "睡眠档案页"
    const val page_add_disease_record = "添加病程记录页" //h5
    const val page_allergy_history = "过敏史页" // h5
    const val page_urgent_history = "手术外伤史页"
    const val page_family_disease_history = "家族遗传病史" // h5
    const val page_online_report_detail = "报告详情页"
    const val page_my_medal = "我的勋章页"
    const val page_medal_detail = "勋章详情页"
    const val page_device_management = "设备管理页"
    const val page_exchange_center = "兑换中心页"
    const val page_setting = "设置页"
    const val page_reminder_setting = "提醒设置页"
...
//    const val click_login_page_get_captcha = "click_captcha"
