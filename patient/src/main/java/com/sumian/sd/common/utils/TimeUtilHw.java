...
public final class TimeUtilHw {
    ...
    public static void printCalendar(Calendar calendar) {
        System.out.println(TimeUtilHw.formatCalendar(calendar));
    }
...
//            CharSequence concat = TextUtils.concat(charSequence, " ");
        ...
        int hour = TimeUtilHw.getHourFromSecond(second);
        int minute = TimeUtilHw.getMinuteFromSecond(second);
