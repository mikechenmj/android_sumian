...
public interface IMediaPlayer {
    ...
    void setDataSource(String vid, String playAuth);
    ...
    void setOnTimedTextListener(OnTimedTextListener var1);

    void setOnLoadingListener(OnLoadingLister loadingListener);
    ...
    public interface OnTimedTextListener {
        void onTimedText(IMediaPlayer var1, String var2);
    }
