 ...
 *     time   : 2018/6/21 16:37
 *     desc   : ref：https://www.jianshu.com/p/d25743da213b
 *     version: 1.0
 * </pre>
 */
public class SoftKeyBoardListener implements ViewTreeObserver.OnGlobalLayoutListener {
    private static final int KEYBOARD_HEIGHT_THRESH_HOLD = 200;
    ...
    public void onGlobalLayout() {
        ...
        if (rootViewVisibleHeight - visibleHeight > KEYBOARD_HEIGHT_THRESH_HOLD) {
        ...
        if (visibleHeight - rootViewVisibleHeight > KEYBOARD_HEIGHT_THRESH_HOLD) {
            if (onSoftKeyBoardChangeListener != null) {
