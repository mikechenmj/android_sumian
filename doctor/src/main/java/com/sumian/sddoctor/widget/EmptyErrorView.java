...
public class EmptyErrorView extends LinearLayout implements View.OnClickListener {
    ...
    public void invalidAdvisoryError() {
        invalid(R.mipmap.ic_empty_state_advisory, R.string.empty_advisory_msg, R.string.empty_advisory_desc);
    }

    /**
     * desc: 暂无留言，留言已被删除
     */
    public void invalidMessageBoardError() {
        mTvEmptyMsgTitle.setTypeface(mTvEmptyMsgTitle.getTypeface(), Typeface.BOLD);
        invalid(R.mipmap.ic_empty_state_advisory, R.string.msg_board_is_deleted,
                R.string.msg_board_is_deleted_message);
    }
