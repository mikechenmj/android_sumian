...
public class Notifier {
    ...
    public static final int PUSH_NOTIFICATION_ID = 0x01;
    ...
    protected void sendNotification(Message message, boolean isForeground, boolean numIncrease) {
        ...
        try {
            ...
            if (msgIntent!= null) {
                msgIntent.putExtra("key_launch_online_customer_service_activity", true);
            }
            notifyID = (new Random().nextInt(100));
            PendingIntent pendingIntent = PendingIntent.getActivity(appContext, PUSH_NOTIFICATION_ID, msgIntent, PendingIntent.FLAG_UPDATE_CURRENT);
            ...
            String summaryBody = appContext.getString(R.string.you_receive_an_online_customer_service_reply);
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                ...
                NotificationManagerCompat.from(appContext).notify(PUSH_NOTIFICATION_ID, notification);
            }
