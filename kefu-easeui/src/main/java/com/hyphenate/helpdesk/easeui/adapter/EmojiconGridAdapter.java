    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView == null){
            if(emojiconType == Type.BIG_EXPRESSION){
                convertView = View.inflate(getContext(), R.layout.light_hd_row_big_expression, null);
            }else{
                convertView = View.inflate(getContext(), R.layout.light_hd_row_expression, null);
            }
        }
