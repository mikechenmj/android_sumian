...
public class MessageAdapter extends BaseAdapter {
    ...
    private static final int MESSAGE_TYPE_SENT_EVALUATION = 13;
    private static final int MESSAGE_TYPE_RECV_ROBOT_MENU = 14;
    private static final int MESSAGE_TYPE_SENT_TRANSFER_TO_KEFU = 15;
    private static final int MESSAGE_TYPE_RECV_TRANSFER_TO_KEFU = 16;
    private static final int MESSAGE_TYPE_RECV_ARTICLES = 17;
    private static final int MESSAGE_TYPE_RECV_CUSTOMEMOJI = 18;
    private static final int MESSAGE_TYPE_SENT_CUSTOMEMOJI = 19;
