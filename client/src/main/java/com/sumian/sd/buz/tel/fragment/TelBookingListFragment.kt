package com.sumian.sd.buz.tel.fragment
...
import com.sumian.sd.buz.tel.presenter.TelBookingListPresenter
 ...
 *
 */
class TelBookingListFragment : BaseViewModelFragment<TelBookingListPresenter>(), TelBookingListContract.View, SwipeRefreshLayout.OnRefreshListener, BaseRecyclerAdapter.OnItemClickListener, LoadMoreRecyclerView.OnLoadCallback {
