package com.sumian.common.h5.factory;
...
public class WebViewTlsSniSocketFactory extends SSLSocketFactory {
    ...
    public Socket createSocket(Socket plainSocket, String host, int port, boolean autoClose) throws IOException {
        ...
        if (isDebug()) {
            Log.d(TAG, "Established " + session.getProtocol() + " connection with " + session.getPeerHost() + " using " + session.getCipherSuite());
        }
