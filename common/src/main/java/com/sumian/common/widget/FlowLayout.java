...
public class FlowLayout extends ViewGroup {
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null) {
            ...
            vSpace = a.getDimensionPixelOffset(R.styleable.FlowLayout_sd_VerticalSpace, vSpace);
            hSpace = a.getDimensionPixelOffset(R.styleable.FlowLayout_sd_HorizontalSpace, hSpace);
            a.recycle();
        }
