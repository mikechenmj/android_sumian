package com.sumian.sleepdoctor.widget.fold;
 ...
 * desc:
 **/
public class FoldTextView extends EmojiAppCompatTextView implements View.OnClickListener {

    private static final int DEFAULT_SHOW_LINE_COUNT = 4;

    private int mDefaultShowLine = DEFAULT_SHOW_LINE_COUNT;//默认设置显示的 text 行数
