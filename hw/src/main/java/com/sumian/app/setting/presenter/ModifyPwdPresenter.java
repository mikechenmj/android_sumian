...
import com.sumian.app.setting.contract.ModifyPwdContract;
    ...
    public void doResetPwd(ModifyPwdBody modifyPwdBody) {
        ...
        call.enqueue(new BaseResponseCallback<Object>() {
            ...
            protected void onSuccess(Object response) {
                ...
                AppManager.getAccountModel().updateUserCache(null);
                AppManager.getAccountModel().updateTokenCache(null);
