package com.sumian.app.improve.device.fragment;
...
import com.sumian.app.improve.device.contract.DeviceContract;
import com.sumian.app.improve.device.dialog.PaModeDialog;
import com.sumian.app.improve.device.dialog.PairOnDeviceDialog;
import com.sumian.app.improve.device.presenter.DevicePresenter;
import com.sumian.app.improve.device.sheet.DeviceBottomSheet;
import com.sumian.app.improve.widget.device.DeviceGuideStepOneView;
import com.sumian.app.improve.widget.device.DeviceStatusView;
import com.sumian.app.improve.widget.device.FloatGroupView;
import com.sumian.app.improve.widget.dialog.SumianDialog;
import com.sumian.app.job.JobTask;
...
//                        }
    ...
    public void onResume() {
        ...
        if (BuildConfig.IS_CLINICAL_VERSION) {
            ...
            boolean haveUserInfoAndSleepBarrierTest = AppManager.getAccountModel().isHaveUserInfoAndSleepBarrierTest();
