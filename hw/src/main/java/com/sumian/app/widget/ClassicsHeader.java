...
public class ClassicsHeader extends RelativeLayout implements RefreshHeader {
    ...
    public static String REFRESH_HEADER_PULLDOWN = "下拉刷新睡眠数据";
    public static String REFRESH_HEADER_REFRESHING = "加载中...";
    public static String REFRESH_HEADER_LOADING = "正在加载...";
    public static String REFRESH_HEADER_RELEASE = "释放更新睡眠数据";
    public static String REFRESH_HEADER_FINISH = "刷新完成";
    public static String REFRESH_HEADER_FAILED = "刷新失败";
    public static String REFRESH_HEADER_LASTTIME = "上次更新 MM-dd HH:mm:ss";
