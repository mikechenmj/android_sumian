package com.sumian.app.common.captcha;
...
public final class CaptchaTimeDistanceConfig {
    ...
    public static void showTimer(TextView tvCaptcha, boolean isCountDown, String captchaTimeType) {
        ...
        tvCaptcha.setTextColor(tvCaptcha.getResources().getColor(R.color.general_color));
        ...
        mTimer = new CountDownTimer(timeDistance * 1000L, 1000L) {
            ...
            public void onFinish() {
                ...
                tvCaptcha.setText(R.string.captcha_hint);
                tvCaptcha.setTextColor(tvCaptcha.getResources().getColor(R.color.bt_hole_color));
