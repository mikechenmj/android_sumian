...
//
//    fun upgradeBoundDevice(context: Context, target: DeviceType, filePath: String, callback: UpgradeCallback, onDfuCmdSuccess: (() -> Unit)? = null) {
...
//            if (monitorMac == null) {
//                mUpgradeBoundDfuCallback?.onFail(UpgradeCallback.ERROR_CODE_GET_MONITOR_MAC_FAIL, "monitor mac is null")
//                return
//            }
...
//                            mUpgradeBoundDfuCallback?.onFail(UpgradeCallback.ERROR_CODE_GET_SLEEP_MASTER_MAC_FAIL, msg)
//                        }
//                    })
//        }
//    }
        ...
        BleCommunicationController.requestByCmd(dufCmd, object : BleRequestCallback {
            override fun onResponse(data: ByteArray, hexString: String) {
                ...
                if (BleCmd.RESPONSE_CODE_SUCCESS == result) {
                    ...
                    enterDfuCallback.onFail(UpgradeCallback.ERROR_CODE_ENTER_DFU_MODE_FAIL, errMsg)
                }
            }
...
//                    }
//                } else {
//                    mUpgradeBoundDfuCallback?.onFail(UpgradeCallback.ERROR_CODE_ENTER_DFU_MODE_FAIL, getErrorMsg(result))
//                }
//            }
//
//            override fun onFail(code: Int, msg: String) {
...
//                            ?.onFail(UpgradeCallback.ERROR_CODE_GET_MONITOR_MAC_FAIL, "connect device failed")
//                }
//            }
//        })
//    }

    fun startDfuUpgrade(dfuMac: String, filePath: String, dfuCallback: UpgradeCallback? = null) {
        ...
        DfuServiceListenerHelper.registerProgressListener(
            ...
            override fun onDfuAborted(deviceAddress: String) {
                ...
                dfuCallback?.onFail(UpgradeCallback.ERROR_CODE_DFU_ABORTED, "dfu was aborted")
