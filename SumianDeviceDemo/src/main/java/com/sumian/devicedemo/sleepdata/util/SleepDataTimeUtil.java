...
public final class SleepDataTimeUtil {
    ...
    public static void printCalendar(Calendar calendar) {
        System.out.println(SleepDataTimeUtil.formatCalendar(calendar));
    }
...
//            CharSequence concat = TextUtils.concat(charSequence, " ");
        ...
        int hour = SleepDataTimeUtil.getHourFromSecond(second);
        int minute = SleepDataTimeUtil.getMinuteFromSecond(second);
