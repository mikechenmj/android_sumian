...
public class SleepAvgAndCompareView extends ConstraintLayout {
    ...
    public SleepAvgAndCompareView setAvgDuration(Integer duration) {
        // CharSequence formatDuration = SleepDataTimeUtil.formatSleepDurationText(getContext(), duration);
...
//            mTvCompareDuration.setText(concat);
            ...
            Drawable leftDrawable = getResources().getDrawable(duration > 0 ? R.drawable.ic_report_up : R.drawable.ic_report_down);
