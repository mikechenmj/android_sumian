package com.sumian.devicedemo.device.widget
 ...
 * version: 1.0
 */
class BatteryProgressView(context: Context, attributeSet: AttributeSet? = null) :
    ...
    private fun getBgColor(): Int {
        return context.resources.getColor(R.color.l3_color)
    }

    private fun getProgressColor(): Int {
        return context.resources.getColor(if (mProgress > 20) R.color.b3_color else R.color.t4_color)
    }
}